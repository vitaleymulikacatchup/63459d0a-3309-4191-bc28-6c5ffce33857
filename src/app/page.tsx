...
export default function Home() {
  ...
  return (
    <SiteThemeProvider theme={{ styleVariant: 'funAndTrendy', colorTemplate: 1, textAnimation: 'slide' }}>
      <NavbarBase logoSrc="/images/logo.svg" logoAlt="GiggleCoin Logo" leftButtonText="" rightButtonText="Buy GiggleCoin" onLeftButtonClick={() => {}} onRightButtonClick={() => alert('Buying GiggleCoin')} />
      ...
      <FooterBase logoSrc="/images/logo.svg" columns={[{ title: 'Links', items: [{ label: 'Home', onClick: () => {} }, { label: 'About', onClick: () => {} }, { label: 'Contact', onClick: () => {} }] }, { title: 'Social', items: [{ label: 'Twitter', onClick: () => {} }, { label: 'Discord', onClick: () => {} }, { label: 'GitHub', onClick: () => {} }] }]} copyrightText="© 2023 GiggleCoin. All rights reserved." onPrivacyClick={() => alert('Privacy Policy')} />
    </SiteThemeProvider>
  );
}